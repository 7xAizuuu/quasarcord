...
const REPO_URL = "https://github.com/quasarcordoff/quasarcord";
...
function UpdaterTab() {
    ...
    return (
        <SettingsTab>
            <Heading className={Margins.top16}>QuasarCord Updater</Heading>
            <Paragraph className={Margins.bottom20}>
                Check for new versions of QuasarCord. Updates can be installed automatically.
            </Paragraph>
            ...
            <Card style={{ padding: "12px 16px", marginBottom: 12 }}>
                <Flex style={{ alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div>
                        ...
                        <div>
                            <Link href="https://quasarcord.online" style={{ fontSize: 13 }}>
                                quasarcord.online
                            </Link>
                        </div>
                    </div>
