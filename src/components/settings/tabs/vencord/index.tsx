...
import { ContributeModal } from "../../../../quasarcord/renderer/components/ContributeModal";
...
const DEV_TEAM = [
    {
        ...
        description: "Founder and owner of QuasarCord."
    },
    {
        id: "kza",
        name: "Kza",
        ...
        description: "Co-owner of QuasarCord."
    },
    {
        id: "attachante",
        name: "attachante",
        ...
        description: "Developer within the QuasarCord team."
    },
    {
        id: "Fancy",
        name: "Fancy",
    ...
    },
    {
        ...
        description: "Bot developer for QuasarCord."
    },
    {
        id: "biemal",
        name: "Biemal",
        ...
        description: "WebApp developer within the QuasarCord team."
    }
];
    ...
    return (
        <>
            <QuickActionCard>
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="QuasarCord Server"
                    action={() => window.open("https://discord.gg/quasarcord", "_blank")}
                />
            </QuickActionCard>
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("quasarcord-stealth-change", handler);
        return () => window.removeEventListener("quasarcord-stealth-change", handler);
    }, []);
    return active;
}
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {enabled
                    ? "Stealth mode is enabled — all QuasarCord visual elements are hidden. Shortcut: Ctrl+Shift+H"
                    : "Hides all QuasarCord visual elements (icons, buttons, context menus) without disabling plugins. Shortcut: Ctrl+Shift+H"}
            </Paragraph>
            <Button
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how QuasarCord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how QuasarCord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
                </Paragraph>
            ...
            <Heading className={Margins.top20}>Stealth Mode</Heading>
            <Paragraph className={Margins.bottom16}>
                Hides all QuasarCord visual elements without disabling plugins. Shortcut: Ctrl+Shift+H
            </Paragraph>
            <StealthModeButton />
...
export default wrapTab(EquicordSettings, "QuasarCord Settings");
