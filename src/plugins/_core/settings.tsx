...
import IconsTab from "@quasarcordplugins/iconViewer/components/IconsTab";
...
import { CreateThemeTab } from "@quasarcordplugins/createTheme/components/CreateThemeTab";
import { PencilSparkleIcon } from "@quasarcordplugins/createTheme/components/PencilSparkleIcon";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the QuasarCord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const mainEntry = buildEntry({
            key: "equicord_main",
            title: "QuasarCord",
            panelTitle: "QuasarCord Settings",
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("QuasarCord_stealthMode") === "1") return ""; } catch { }
                return "QuasarCord Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("QuasarCord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`QuasarCord ${gitHashShort}${getVersionInfo()}`];
