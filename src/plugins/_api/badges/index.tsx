...
let QuasarCordBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    ...
    const quasarcordBadges = await loadBadges("https://gist.githubusercontent.com/quasarcordoff/29ff0da4ebd5a7e36acdf97be24f28c9/raw/badges.json", noCache).catch(() => ({}));

    DonorBadges = vencordBadges;
    EquicordDonorBadges = equicordBadges;
    QuasarCordBadges = quasarcordBadges;
}
...
export default definePlugin({
    ...
    get QuasarCordBadges() {
        return QuasarCordBadges;
    },
    ...
    getQuasarCordBadges(userId: string) {
        try {
            const userBadges = QuasarCordBadges[userId];
            ...
            for (const badge of userBadges) {
                ...
                results.push({
                    iconSrc: iconSrc,
                    description: (badge as any).tooltip || (badge as any).description || (badge as any).label || "QuasarCord Badge",
