...
import { Logger } from "@QuasarCord/types/utils";
import { findLazy, onceReady } from "@QuasarCord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@QuasarCord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("QuasarCordRPC", "#5865f2");
