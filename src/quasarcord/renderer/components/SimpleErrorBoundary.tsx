...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@QuasarCord/types/components";
import { FluxDispatcher, InviteActions } from "@QuasarCord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure QuasarCord and QuasarCord are fully up to date. You can get help in our{" "}
