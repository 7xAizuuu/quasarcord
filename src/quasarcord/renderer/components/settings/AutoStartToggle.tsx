...
import { useState } from "@QuasarCord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start QuasarCord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start QuasarCord minimized when starting with system"}
