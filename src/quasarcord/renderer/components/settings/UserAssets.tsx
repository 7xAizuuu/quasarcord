...
import { BaseText, Button, FormSwitch } from "@QuasarCord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@QuasarCord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`quasarcord://assets/${asset}?v=${version}`}
                    alt=""
