...
import { Button, Card, HeadingTertiary, Paragraph } from "@QuasarCord/types/components";
import { useAwaiter } from "@QuasarCord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your QuasarCord is outdated!</HeadingTertiary>
