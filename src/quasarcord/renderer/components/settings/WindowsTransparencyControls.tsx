...
import { Heading, Paragraph } from "@QuasarCord/types/components";
import { Margins } from "@QuasarCord/types/utils";
import { Select } from "@QuasarCord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind QuasarCord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
