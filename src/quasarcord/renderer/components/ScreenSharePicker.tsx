...
import {
    ...
    RestartIcon,
    Span
} from "@QuasarCord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@QuasarCord/types/webpack/common";
...
const logger = new Logger("QuasarCordScreenShare");
