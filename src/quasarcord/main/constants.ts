...
const QuasarCordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(QuasarCordDir, "Uninstall QuasarCord.exe"));

export const DATA_DIR =
    process.env.QuasarCord_USER_DATA_DIR || (PORTABLE ? join(QuasarCordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `QuasarCord/${app.getVersion()} (https://github.com/QuasarCord/QuasarCord)`;
