...
export async function downloadVencordAsar() {
    await downloadFile(
        "https://github.com/QuasarCord/QuasarCord/releases/latest/download/QuasarCord.asar",
        VENCORD_DIR,
        {},
...
export function isValidVencordInstall(dir: string) {
    return existsSync(join(dir, "QuasarCord/main.js"));
}

export async function ensureVencordFiles() {
    if (!existsSync(VENCORD_DIR)) {
        console.error("Bundled quasarcord.asar not found at", VENCORD_DIR);
    }
}
