...
export default definePlugin({
    name: "UserAreaTweaks",
    description: "Creates an elegant floating dock for QuasarCord plugins using pure CSS, preventing overlap and crashes.",
    authors: [{ name: "QuasarCord", id: 0n }],
    enabledByDefault: true,

    start() {
        const style = document.createElement("style");
        style.id = "quasarcord-userarea-tweaks-style";
        style.textContent = CSS;
        document.head.appendChild(style);
    },

    stop() {
        document.getElementById("quasarcord-userarea-tweaks-style")?.remove();
    }
});
