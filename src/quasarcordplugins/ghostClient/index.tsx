...
const DS_KEY_TOKENS = "quasarcord-ghost-tokens";
const DS_KEY_AUTO_FOLLOW = "quasarcord-ghost-autofollow";
const DS_KEY_MIC_DEVICE = "quasarcord-ghost-mic-device-label";
const DS_KEY_SELECTED = "quasarcord-ghost-selected";
