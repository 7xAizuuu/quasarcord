...
const REMOTE_VERSION_URL =
    "https://api.github.com/repos/quasarcordoff/quasarcord/releases/latest";
...
async function checkForUpdates() {
    try {
        ...
        console.log(`[QuasarCordUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[QuasarCordUpdater] Error vérification:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            console.error("[QuasarCordUpdater] Error mise à jour:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `🔔 QuasarCord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("quasarcord-updater-root")) return;
    bannerContainer = document.createElement("div");
    bannerContainer.id = "quasarcord-updater-root";
    ...
    try {
        ...
        console.error("[QuasarCordUpdater] Error montage bannière:", e);
    }
}
