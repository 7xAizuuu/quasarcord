...
export default definePlugin({
    ...
    description: "Hides all plugin buttons without disabling them. Shortcut: Ctrl+Shift+H. The toggle is in QuasarCord Settings.",
    ...
    stop() {
        document.body.classList.remove("quasarcord-stealth");
    },
});
