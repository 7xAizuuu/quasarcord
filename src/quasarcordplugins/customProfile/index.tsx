...
const LS_KEY_DATA = "QuasarCordCP_data";
const LS_KEY_ENABLED = "QuasarCordCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "QuasarCordCP_allData";
const LS_ALL_ENABLED = "QuasarCordCP_allEnabled";
