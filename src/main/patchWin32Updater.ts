...
function patchLatest() {
    try {
        ...
        console.info("[QuasarCord] Detected Host Update. Repatching...");
        ...
        writeFileSync(join(app, "index.js"), `// QuasarCord repatch\n"use strict";\nconst path = require("path");\nrequire(path.join(__dirname, "..", "app", "dist", "desktop", "patcher.js"));`);
    } catch (err) {
        console.error("[QuasarCord] Failed to repatch latest host update", err);
    }
}
