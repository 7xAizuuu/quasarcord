# ==============================================================================
#  QuasarCord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection QuasarCord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "QuasarCord-Client"
...
Write-Host "  ║      QUASARCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  QuasarCord désinstallé avec succès !                 │" -ForegroundColor Green
