# ==============================================================================
#  QuasarCord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter QuasarCord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de QuasarCord
$QuasarCordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$QuasarCordPatcher = $QuasarCordPatcher.Replace("\", "\\")
...
// Injection QuasarCord
try {
    require(\"$QuasarCordPatcher\");
} catch (e) {
    console.error(\"QuasarCord injection failed:\", e);
